...
#ifndef ORBITMAC_SWIFT_H
#define ORBITMAC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ORBITMac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8ORBITMac16OrbitAppDelegate")
@interface OrbitAppDelegate : NSObject <NSApplicationDelegate>
- (void)applicationDidFinishLaunching:(NSNotification * _Nonnull)notification;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC8ORBITMac21OrbitSpeechController")
@interface OrbitSpeechController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVSpeechSynthesizer;
@class AVSpeechUtterance;
@interface OrbitSpeechController (SWIFT_EXTENSION(ORBITMac)) <AVSpeechSynthesizerDelegate>
...
SWIFT_CLASS("_TtC8ORBITMac26OrbitSpeechInputController")
@interface OrbitSpeechInputController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
